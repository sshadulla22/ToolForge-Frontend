...
const converters = [
  { title: "PDF → DOCX", apiUrl: "http://127.0.0.1:8000/convert/pdf-to-docx", accept: ".pdf", outputExt: ".docx" },
  { title: "DOCX → PDF", apiUrl: "http://127.0.0.1:8000/convert/docx-to-pdf", accept: ".docx", outputExt: ".pdf" },
  { title: "PDF → Image", apiUrl: "http://127.0.0.1:8000/convert/pdf-to-image", accept: ".pdf", outputExt: ".jpg" },
  { title: "Image → PDF", apiUrl: "http://127.0.0.1:8000/convert/image-to-pdf", accept: "image/*", outputExt: ".pdf" },
  { title: "PPT → PDF", apiUrl: "http://127.0.0.1:8000/convert/ppt-to-pdf", accept: ".ppt,.pptx", outputExt: ".pdf" },
  { title: "Excel → PDF", apiUrl: "http://127.0.0.1:8000/convert/excel-to-pdf", accept: ".xls,.xlsx", outputExt: ".pdf" },
